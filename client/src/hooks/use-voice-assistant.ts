    ...
    const routePatterns = [
      ...
      },
      {
        ...
        patterns: [
          ...
          // Tamil
          /\b(நோய்|உடல்நலம்|பகுப்பாய்வு|நோய்கண்டறிதல்|வியாதி|பிரச்சனை|கண்காணிப்பு)\b/,
          /\b(noy|udalnalam|pakuppaayvu|noykandaridhaal|viyaadhi|prachanai|kankaanippu)\b/,
          /நோய்.*கண்காணிப்பு/,
          // Kannada
      ...
      },
      {
        ...
        patterns: [
          ...
          /\b(முகப்பு|வீடு|தொடக்கம்|ஹோம்|பின்னாடியே|கோ)\b/,
          /கோ\s*பேக்/,
          /பின்னாடியே\s*போ/,
